  ...
  return (
    <div className="rounded-md bg-green-50 p-4">
      <div className="flex">
        ...
        <div className="ml-3">
          <h3 className="text-sm font-mono text-green-800">Configure completed</h3>
          <div className="mt-2 text-sm text-green-700">
            <p className="font-mono">Add and view expense from the navigation tab !!</p>
          </div>
          <div className="mt-4">
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
                        ...
                        <div className="py-4">
                            <div className="border-gray-200 rounded-lg h-96" >
                                {data && data.length>0 && <ErrorCard title="Error with configuration" list={data}/>}
