...
const AddExpense = () => {
  ...
  return (
    <>
      <SideBar />
      <div className="md:pl-72 flex flex-col flex-1  h-screen overflow-y-auto bg-gray-900">
        <div className="py-6">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h1 className="text-2xl  text-white font-mono">Add Expense</h1>
          </div>
                ...
                <div className="grid place-items-center mt-10 pt-10 ">
                  <form className="w-full max-w-lg " onSubmit={formSubmit}>
                    ...
                    <div className="flex flex-wrap -mx-3 mb-3 justify-center items-center">
                      <div className=" md:w-1/2 px-3 mb-3 md:mb-0">
                        <label
                          className="block uppercase tracking-wide text-white text-xs font-mono mb-2"
                          htmlFor="grid-state"
                        >
                          Type
                        </label>
                        <div className="relative">
                          <Forms.TypeFormField
                            ...
                            className="font-mono block appearance-none w-full bg-white border border-white text-black py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                            id="grid-state"
                          />
                      ...
                      <div className=" md:w-1/2 px-3 mb-3 md:mb-0">
                        ...
                        <div className="relative">
                          <Forms.CurrencyFormField
                            ...
                            className="font-mono block appearance-none w-full bg-white border border-white text-vlack py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                            id="grid-state"
                          />
                          <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700">
                            <svg
