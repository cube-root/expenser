    ...
    <div className="relative bg-gray-50 px-4 pt-16 pb-20 sm:px-6 lg:px-8 lg:pt-24 lg:pb-28">
      ...
      <div className="relative mx-auto max-w-7xl">
        <div className="text-center">
          <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Integrations</h2>
        ...
        <div className="mx-auto mt-12 grid max-w-lg gap-5 lg:max-w-none lg:grid-cols-3">
          {plugins.map((plugin) => (
            <div key={plugin.title} className="flex flex-col overflow-hidden rounded-lg shadow-lg">
              ...
              <div className="flex flex-1 flex-col justify-between bg-white p-6">
                <div className="flex-1">
                  ...
                  <div className="mt-2 block">
                    <p className="text-xl font-semibold text-gray-900">{plugin.title}</p>
                    <p className="mt-3 text-base text-gray-500">{plugin.description}</p>
                  </div>
                </div>
